...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'terms'                 => 'شرایط',
        'province'              => 'استان',
        'requester_id'          => 'در خواست دهنده',
        'post_receipt_id'       => 'رسید پستی',
        'shipping_date'         => 'تاریخ ارسال',
        'tracking_code'         => 'کد‌رهگیری',
        'shipping_cost'         => 'هزینه ارسال',
        'shipping_method'       => 'روش ارسال',
        'source_id'             => ' منبع',
        'invoice_items.*.id'    => 'شناسه ایتم فاکتور',
        'family'                => 'نام خانوادگی',
        'invoice_items.*.vendor_id' => 'شناسه غرفه',
        'invoice_items.*.invoice_id' => 'شناسه سفارش',
        'number' => 'تعداد',
        'os' => 'سیستم عامل',
        'start' => 'عدد شروع',
        'expired_type' => 'پلن',
